...
def main(config):
    ...
    for epoch in range(config.max_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            x_logits, y_logits, z_logits = generator(rgb_images_masked)
            ...
            # LOSSES Summation
            loss = 1.0 * binary_nocs_loss + 1.0 * regression_nocs_loss
            ...
            if (step + 1) % 100 == 0:
                ...
                print("Epoch {:02d}, Iteration {:03d}, Loss: {:.4f}, Binary NOCS Loss: {:.4f}, Reg NOCS Loss: {:.4f}, lr_gen: {:.6f}, Time per 100 Iterations: {:.4f} seconds".format(
                    epoch, iteration, avg_loss, avg_running_binary_nocs_loss, avg_running_regression_nocs_loss, lr_current, elapsed_time_iteration))
                ...
                plot_progress_imgs(imgfn, rgb_images, rgb_images_masked, nocs_images_normalized_gt, nocs_estimated, mask_images, rotation_gt)
