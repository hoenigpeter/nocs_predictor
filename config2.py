...
val_data_root = "/media/ssd2/peter/datasets/housecat6d_nocs_test/test_scene{1..5}.tar"
test_data_root = "/media/ssd2/peter/datasets/housecat6d_nocs_test/test_scene{1..5}.tar"
