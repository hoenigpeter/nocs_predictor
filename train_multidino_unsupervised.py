...
from networks import UnetGeneratorMultiHead, UnetGeneratorMultiHeadRot
...
def main(config):
    ...
    generator = UnetGeneratorMultiHeadRot(input_nc=3, output_nc=50, num_heads=3, num_downs=5, ngf=64)
    generator.to(device)
    print(generator)
